        ...
        static void Main()
        {
            ...
            foreach (string x in soda) //this picks the each value in the lists
            {
                ...
                foreach (string y in soda) //this cycles thru the items in the list again
                {
                    ...
                    {
                        Console.WriteLine("This " + y + " is unique."); //prints message
                        count = count + 1; //adds a point to the count
                    }
                    else if (pop == y && count == 1) // if the item is the same and we already have counted one then we print the message below
                    {
                        Console.WriteLine("This " + y + " is a duplicate.");
                    }
                    else //this prints default if the items don't match eachother.
                    {
                        Console.WriteLine("This " + y + " is unique.");
                    }
